    ...
    <nav id="navigation"> 
      <div class="container">
        <ul id="primary-links">
          ...
          <li><a class="cart-contents button" href="<?php echo wc_get_cart_url(); ?>" title="<?php _e( 'Cart Items' ); ?>"><?php echo sprintf ( _n( '%d', '%d', WC()->cart->get_cart_contents_count() ), WC()->cart->get_cart_contents_count() ); ?></a>
          </li>
